...
public class InstaceOfAndCasting {
    ...
    public static void instanceOf() {
        ...
        System.out.println("1.3 :" + !(c instanceof Dog));
        ...
        System.out.println("1.9 :" + !(chiwawa instanceof Cat));
    ...
    public static void compilationOKorNot() {
        ...
        Chiwawa c = new Chiwawa();  // not compiled because you down see chiwawa in animal you see it in dog
    ...
    public static void casting() {
        ...
        Dog d = new Dog();
        //Chiwawa c = (Chiwawa)d;  runtime error because we are down casting
