...
class OtherMethod {
    ...
    // (1) You know this is a [      ] method. So, you don't need to [        ] this.
    // (2) The method [sum] has two [          ]: x of type [   ] and y of type [   ]
...
public class MethodsBasic {
    public static void main(String[] args) {
        ...
        // (3) You [    ] the sum method without [         ], because the sum method is [    ].
        // (4) The static method is in the class [        ], so you should prepend the name
        //     before you use the method. 
        // (5) You give [       ] 1 and 100, both of type [   ], to the method sum.
        ...
        // (8) You should [           ]: copy the class into a [       ] JVM memory.
        // (9) You use [   ] operator to [         ] an [     ]. 
